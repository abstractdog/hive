 ...
 */
public class CastLongToDecimalOld extends FuncLongToDecimalOld {

  private static final long serialVersionUID = 1L;

  public CastLongToDecimalOld() {
    super();
  }

  public CastLongToDecimalOld(int inputColumn, int outputColumnNum) {
