...
package org.apache.hive.benchmark.vectorization.expressions.old;
 ...
 */
public abstract class FuncLongToDecimalOld extends VectorExpression {
  private static final long serialVersionUID = 1L;
  private final int inputColumn;

  public FuncLongToDecimalOld(int inputColumn, int outputColumnNum) {
    super(outputColumnNum);
    this.inputColumn = inputColumn;
  }

  public FuncLongToDecimalOld() {
    super();
