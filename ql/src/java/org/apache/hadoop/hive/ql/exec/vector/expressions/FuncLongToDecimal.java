...
/**
 * This is a superclass for unary long functions and expressions returning decimals that operate
...
public abstract class FuncLongToDecimal
  ...
  public VectorExpressionDescriptor.Descriptor getDescriptor() {
    ...
    b.setMode(VectorExpressionDescriptor.Mode.PROJECTION).setNumArguments(1)
        .setArgumentTypes(VectorExpressionDescriptor.ArgumentType.INT_FAMILY)
