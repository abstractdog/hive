...
public class TestVectorPTFGroupBatches {
  ...
  private void init(VectorPTFGroupBatches groupBatches) throws HiveException {
    ...
    groupBatches.init(
        ...
        new TypeInfo[] { getTypeInfo("string"), getTypeInfo("int"), getTypeInfo("string") },
        /* evaluators */ new VectorPTFEvaluatorBase[] {
            new VectorPTFEvaluatorCountStar(
                new WindowFrameDef(WindowType.RANGE, new BoundaryDef(Direction.PRECEDING, 1),
        ...
        /* outputTypeInfos */ outputTypeInfos,
        /* orderColumnMap */ new int[]{1},
        /* orderColumnVectorTypes */ new ColumnVector.Type[] { ColumnVector.Type.LONG }, // p_date is a long
        /* keyInputColumnMap */ new int[]{0, 1}, //p_mfgr, p_name
        /* nonKeyInputColumnMap */ new int[]{2},
        /* streamingEvaluatorNums */  new int[0],
        /* scratchColumnPositions */ new int[0],
        /* scratchColumnTypeNames */ new String[0],
        getFakeOperator().setupOverflowBatch(3,
                new String[] { "bigint", "bigint" }, outputProjectionColumnMap, outputTypeInfos));
  }
