...
public class TestValueBoundaryScanner {
  ...
  public void testLongEquals() {
    ...
    LongValueBoundaryScanner scanner =
        new LongValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
  ...
  public void testHiveDecimalEquals() {
    ...
    HiveDecimalValueBoundaryScanner scanner =
        new HiveDecimalValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
  ...
  public void testDateEquals() {
    ...
    DateValueBoundaryScanner scanner =
        new DateValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
    Date date = new Date();
  ...
  public void testTimestampEquals() {
    ...
    TimestampValueBoundaryScanner scanner =
        new TimestampValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
  ...
  public void testTimestampLocalTZEquals() {
    ...
    TimestampLocalTZValueBoundaryScanner scanner =
        new TimestampLocalTZValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
  ...
  public void testStringEquals() {
    ...
    StringValueBoundaryScanner scanner =
        new StringValueBoundaryScanner(null, null, new OrderExpressionDef(argDef));
    Text w1 = new Text("a");
    Text w2 = new Text("b");
