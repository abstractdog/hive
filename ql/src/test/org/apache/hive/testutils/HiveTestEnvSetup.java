 ...
 *  </ul>
 */
public class HiveTestEnvSetup extends ExternalResource implements BeforeAllCallback, AfterAllCallback {
  ...
  class MethodRuleProxy extends ExternalResource implements BeforeEachCallback, AfterEachCallback {
