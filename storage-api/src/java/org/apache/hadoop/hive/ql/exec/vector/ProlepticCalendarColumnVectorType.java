...
/**
 * Column vectors implementing this interface are supposed to implement proleptic calendar semantics regarding their values.
 */
public interface ProlepticCalendarColumnVectorType {
  /**
